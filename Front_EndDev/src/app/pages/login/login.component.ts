...
export class LoginComponent {
 constructor(private apiservice: ApipeticionesService, private router: Router,private authService: AthenticationService){
...
errorAlert(str:string){
 ...
 handleConsole(){
  ...
  this.apiservice.loginUser(user).subscribe((data:any)=>{
